...
GameObject* sphere1 = new Sphere(glm::vec3(-3, 0, 0), 1.f);

GameObject* player1 = new Player(1.f, glm::vec3(3, 0, 0));

GameObject* cubeplayer = new cubePlayer(1.f, glm::vec3(3, 0, 0));

//GameObject* rotating = new RotatingSquare(1.f, 1.f, glm::vec3(0, 0, 0));
